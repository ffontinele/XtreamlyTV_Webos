...
(function () {
  ...
  var QRUtil = {
    ...
    getBCHTypeInfo: function (data) { var d = data << 10; while (QRUtil.getBCHDigit(d) - QRUtil.getBCHDigit(QRUtil.G15) >= 0) d = (d << (QRUtil.getBCHDigit(d) - QRUtil.getBCHDigit(QRUtil.G15))) ^ QRUtil.G15; return ((data << 10) | d) ^ QRUtil.G15_MASK; },
    getBCHTypeNumber: function (data) { var d = data << 12; while (QRUtil.getBCHDigit(d) - QRUtil.getBCHDigit(QRUtil.G18) >= 0) d = (d << (QRUtil.getBCHDigit(d) - QRUtil.getBCHDigit(QRUtil.G18))) ^ QRUtil.G18; return (data << 12) | d; },
